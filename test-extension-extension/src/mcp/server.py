...
class MCPHandler(BaseHTTPRequestHandler):
    ...
    def _get_tools(self):
        ...
        return [
            {
                "name": "item_search",
                "description": "Search Items capability",
                "inputSchema": {
                    "type": "object",
                    "properties": {
                        "input": {"type": "string", "description": "Input for search"}
                    }
                }
            },
        ]
    ...
    def _handle_tool(self, tool_name, arguments):
        ...
        # TODO: Implement test-extension-extension domain logic
...
def start_server():
    ...
    print(f"Test Extension MCP Server")
